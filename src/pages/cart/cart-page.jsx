...
export const CartPage = () => {
    ...
    return (
        <>
            ...
            <div className="ms-2 mt-5 mb-4 me-2">
                ...
                <button className="z-[2] inline-block rounded bg-red-800 text-white px-6 pb-[6px] ms-4" onClick={backShop}>
                    Return To Shop
                </button>
                ...
                {cart.lenght > 0 && <button className="float-end z-[2] inline-block rounded bg-red-800 text-white px-6 pb-[6px] ms-4">
                    Update Cart
                </button>}
            </div>

            {cart.lenght > 0 && <div className="grid grid-cols-2 gap-2 ms-2 mt-5 me-2 mb-5">
                <div>
                    <div className="relative mb-4 flex flex-wrap items-stretch">
